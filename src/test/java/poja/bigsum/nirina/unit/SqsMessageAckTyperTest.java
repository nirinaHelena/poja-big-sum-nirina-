package poja.bigsum.nirina.unit;
...
import poja.bigsum.nirina.endpoint.event.EventConsumer;
...
public class SqsMessageAckTyperTest extends FacadeIT {
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent =
        new EventConsumer.TypedEvent("poja.bigsum.nirina.endpoint.event.gen.UuidCreated", payload);
